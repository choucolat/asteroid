...
def draw_porkchop(
    ...
    if dv_levels is not None and len(dv_levels):
        ...
        dv_labels = ax.clabel(
            dv_lines, inline=True, fmt="%g km/s", fontsize=9, colors=INK_DV
        )
...
def main() -> None:
    ...
    print("\nBest intercept (flyby / kinetic impactor):")
    print(
    ...
    print(
        "\nWrote porkchop_yr4_2028_intercept.png, porkchop_yr4_2028_rendezvous.png, "
        "porkchop_yr4_overview.png, porkchop_yr4_grids.npz"
    )
